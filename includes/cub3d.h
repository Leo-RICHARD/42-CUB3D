...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/19 15:53:00 by lrichard          #+#    #+#             */
/*   Updated: 2021/10/04 20:01:40 by lrichard         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int					segfaults_right(t_args *args, t_controls *inputs, \
																float *pos);
int					segfaults_left(t_args *args, t_controls *inputs, \
																float *pos);
int					segfaults_backward(t_args *args, t_controls *inputs, \
																float *pos);
int					segfaults_forward(t_args *args, t_controls *inputs, \
																float *pos);
